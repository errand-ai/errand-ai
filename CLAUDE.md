...
- Version: `0.13.0` (in `VERSION` file) — bump per semver before committing (CI enforces immutable tags)
...
- Tests: 135 backend (pytest) + 122 frontend (vitest) — CI `test` job gates both build jobs
