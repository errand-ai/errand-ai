...
vi.mock('../../composables/useApi', () => ({
  ...
  createTask: vi.fn().mockResolvedValue({ id: 'new-1', title: 'New', description: null, status: 'new', position: 0, category: 'immediate', execute_at: null, repeat_interval: null, repeat_until: null, tags: [], created_at: '', updated_at: '', output: null, retry_count: 0 }),
  updateTask: vi.fn().mockResolvedValue({ id: '1', title: 'Test', description: null, status: 'running', position: 0, category: 'immediate', execute_at: null, repeat_interval: null, repeat_until: null, tags: [], created_at: '', updated_at: '', output: null, retry_count: 0 }),
...
describe('TaskStore WebSocket integration', () => {
  ...
  it('adds a new task on task_created event', () => {
    ...
    capturedOptions!.onMessage({
      event: 'task_created',
      task: { id: 'ws-1', title: 'WebSocket task', description: null, status: 'new', position: 0, category: 'immediate', execute_at: null, repeat_interval: null, repeat_until: null, tags: [], output: null, retry_count: 0, created_at: '2026-01-01T00:00:00', updated_at: '2026-01-01T00:00:00' },
    })
  ...
  it('updates an existing task on task_updated event', () => {
    const store = useTaskStore()
    store.tasks = [
      { id: 'existing-1', title: 'Existing', description: null, status: 'new', position: 0, category: 'immediate', execute_at: null, repeat_interval: null, repeat_until: null, tags: [], output: null, retry_count: 0, created_at: '2026-01-01T00:00:00', updated_at: '2026-01-01T00:00:00' },
    ]
  ...
  it('does not duplicate task on repeated task_created', () => {
    ...
    const task = { id: 'dup-1', title: 'Dup', description: null, status: 'new' as const, category: 'immediate', execute_at: null, repeat_interval: null, repeat_until: null, tags: [] as string[], output: null, retry_count: 0, created_at: '', updated_at: '' }
