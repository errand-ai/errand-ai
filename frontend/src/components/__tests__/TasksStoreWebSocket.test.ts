...
describe('TaskStore WebSocket integration', () => {
  ...
  it('does not duplicate task on repeated task_created', () => {
    ...
    const task = { id: 'dup-1', title: 'Dup', description: null, status: 'new' as const, category: 'immediate', execute_at: null, repeat_interval: null, repeat_until: null, tags: [] as string[], created_at: '', updated_at: '' }
