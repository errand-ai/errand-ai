...
Make a task's context consumption measurable rather than inferred: what each turn actually cost, how close the task is to its ceiling, and what filled the context when it mattered.
