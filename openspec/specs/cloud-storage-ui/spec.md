...
Settings → Integrations → "Cloud Storage" section UI. Displays the OneDrive integration card with availability/connection states. Google Drive has moved to its own "Google Workspace" section (see `google-workspace-settings-ui` spec).
