...
Model-aware max output token resolution and configuration for the task-runner agent, preventing output truncation by setting appropriate `max_tokens` on LLM calls.
