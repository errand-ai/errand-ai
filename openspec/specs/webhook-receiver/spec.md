...
HTTP endpoint that receives inbound webhooks from external services (Jira, GitHub, etc.), verifies HMAC signatures, deduplicates events, and dispatches payloads to source-specific handlers as tracked async background tasks.
