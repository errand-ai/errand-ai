...
- **THEN** the worker queries the database for `task_processing_model`, `system_prompt`, `mcp_servers`, `ssh_private_key`, and `git_ssh_hosts` settings before creating the container
