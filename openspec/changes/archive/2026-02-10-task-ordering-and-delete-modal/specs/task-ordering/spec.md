...
Tasks in the New, Pending, Running, Review, and Completed columns SHALL be displayed ordered by `position` ascending, with ties broken by `created_at` ascending.
